...
namespace YouTubeVideoDownloader.YouTubeDataOperations.Models.WebRequestResponse.Response
{
    ...
    /// </summary>
    public class GetVideoInfoResponse : BaseResponse, IYouTubeVideoInfoResponse<MainInfo>
    {
        ...
        public GetVideoInfoResponse(Exception exception, string errorMessage)
        ...
        public GetVideoInfoResponse(MainInfo mainInfo, IEnumerable<string> audioBitrates, IEnumerable<string> resolutions, IEnumerable<string> audioFormats, IEnumerable<string> videoFormats, IEnumerable<string> fps, byte[] image)
           : base()
        {
            MainInfo = mainInfo;
