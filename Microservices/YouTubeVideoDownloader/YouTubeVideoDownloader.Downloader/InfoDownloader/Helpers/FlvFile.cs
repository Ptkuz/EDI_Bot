...
using YouTubeVideoDownloader.Downloader.BitOperations;
using YouTubeVideoDownloader.Downloader.EventClasses;
using YouTubeVideoDownloader.Downloader.Exceptions;
using YouTubeVideoDownloader.Downloader.Extractors;
using YouTubeVideoDownloader.Downloader.Interfaces;

namespace YouTubeVideoDownloader.Downloader.InfoDownloader.Helpers
{
    internal class FlvFile : IDisposable
    {
        ...
        private byte[] ReadBytes(int length)
        {
            ...
            {
                throw new ArgumentNullException(nameof(fileStream), "FileStream does not null!");
            }
